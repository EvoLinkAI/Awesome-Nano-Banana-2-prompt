...
### 🚀 赞助商：[通过 EvoLink 使用 Nano Banana 2 — 比 Google 便宜 20%](https://evolink.ai/zh/nano-banana-2)
...
**为什么选择 EvoLink？**
- 🔑 **一个密钥零配置** — 无需 Google Cloud 项目、无需计费配置、无需配额申请。
- 💰 **便宜 20%** — 同一模型，更低价格。
- ⚡ **99.9% 高可用** — 自动故障转移，确保服务不中断。
- 🔌 **兼容 OpenAI** — 几分钟即可迁移。
- 🎨 **200+ 模型** — 一个密钥访问全部模型。

##### 快速开始
1. 在 [EvoLink](https://evolink.ai) 免费注册获取 API Key
2. 发送请求（包含提示词和可选参考图片）
3. 获取生成/编辑后的图片 — 即可部署

👉 **[立即开始 →](https://evolink.ai/zh/nano-banana-2)**

---

## 📖 目录

1. [产品摄影](#1-product-photography-产品摄影)
2. [写实与人像](#2-photorealism--portraits-写实与人像)
3. [街头与纪实](#3-street--documentary-街头与纪实)
4. [全景与风景](#4-panoramic--landscape-全景与风景)
5. [3D 与立体模型](#5-3d--diorama-3d-与立体模型)
6. [创意与艺术](#6-creative--artistic-创意与艺术)
7. [时尚与生活](#7-fashion--lifestyle-时尚与生活)
8. [教育与知识](#8-education--knowledge-教育与知识)
9. [电商与虚拟工作室](#9-e-commerce--virtual-studio-电商与虚拟工作室)
10. [办公与效率](#10-workplace--productivity-办公与效率)
11. [图片编辑与修复](#11-photo-editing--restoration-图片编辑与修复)
12. [室内设计](#12-interior-design-室内设计)
13. [社交媒体与营销](#13-social-media--marketing-社交媒体与营销)
14. [日常生活与翻译](#14-daily-life--translation-日常生活与翻译)
15. [社交与头像](#15-social-networking--avatars-社交与头像)
16. [资源](#16-resources-资源)
17. [贡献](#17-contributing-贡献)
